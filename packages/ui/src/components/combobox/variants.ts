...
export const comboboxVariants = swTwVariants({
  slots: {
    ...
    field: [
      ...
      'has-data-invalid:border-2',
      'has-data-invalid:hover:border-destructive',
      'has-data-invalid:focus-within:border-destructive',
      'has-data-invalid:hover:border-destructive',
      'has-data-invalid:focus-within:border-destructive',
      'has-data-invalid:data-open:border-destructive',
    ],
