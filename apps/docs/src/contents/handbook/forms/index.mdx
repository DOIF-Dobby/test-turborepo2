...
import TimeFormUI from './time-form-ui'
import TimeFormUIRaw from './time-form-ui?raw'
import DateTimeFormUI from './date-time-form-ui'
import DateTimeFormUIRaw from './date-time-form-ui?raw'
...
날짜와 시간 관련 컴포넌트를 사용하는 예제입니다.

<CodeBlock preview={<DateTimeFormUI />} code={DateTimeFormUIRaw} />

## Time Form UI

시간 관련 컴포넌트를 사용하는 예제입니다.

<CodeBlock preview={<TimeFormUI />} code={TimeFormUIRaw} />
